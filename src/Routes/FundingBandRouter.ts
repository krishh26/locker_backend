...
FundingBandRoutes.post('/', authorizeRoles(UserRole.Admin, UserRole.MasterAdmin, UserRole.OrganisationAdmin, UserRole.CentreAdmin), FundingBandController.createFundingBand);
...
FundingBandRoutes.patch('/:id', authorizeRoles(UserRole.Admin, UserRole.MasterAdmin, UserRole.OrganisationAdmin, UserRole.CentreAdmin), FundingBandController.updateFundingBand);

// DELETE /api/v1/funding-band/:id → delete funding band
FundingBandRoutes.delete('/:id', authorizeRoles(UserRole.Admin, UserRole.MasterAdmin, UserRole.OrganisationAdmin, UserRole.CentreAdmin), FundingBandController.deleteFundingBand);
